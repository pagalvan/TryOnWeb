...
export default function ProductosPage() {
  ...
  }, [productos, selectedCategory, searchValue])

  const productoDestacado = productosFiltrados.find((p) => p.destacado) ?? productosFiltrados[0] ?? null
      ...
      <main className="container mx-auto px-4 py-8 md:py-16">
        ...
        {loading ? (
              ...
              <div className="group relative bg-card rounded-3xl border border-border overflow-hidden hover:shadow-2xl transition-all duration-500 hover:scale-[1.02]">
                <div className="grid md:grid-cols-2 gap-0">
                  <div className="relative aspect-square md:aspect-auto overflow-hidden bg-accent">
                    <Image
                      src={productoDestacado.metadata?.image_url || "/placeholder.svg"}
                  ...
                  <div className="p-8 md:p-12 flex flex-col justify-center">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="font-display text-4xl font-bold text-foreground">
                        {formatCurrency(productoDestacado.valor_unitario)}
                      </span>
          ...
          <div className="text-center py-24">
            <h3 className="font-display text-3xl font-bold text-foreground mb-3">Aún no hay productos</h3>
            <p className="text-lg text-muted-foreground">Agrega artículos desde el módulo de inventario</p>
          </div>
        )}
            ...
            {productosRegulares.map((producto, index) => (
              ...
              >
                ...
                >
                  ...
                  >
                    <div className={`relative overflow-hidden bg-accent ${index === 0 ? "aspect-[4/3]" : "aspect-square"}`}>
                      <Image
                    ...
                    <div className="p-6 flex flex-col flex-1">
                      ...
                      <div className="mt-auto pt-4 flex items-center justify-between border-t border-border">
                        <span className="font-display text-2xl font-bold text-foreground">{formatCurrency(producto.valor_unitario)}</span>
                        <div
